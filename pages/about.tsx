    ...
    return (
        <>
            ...
            <SimpleLayout
                ...
                intro={'I am a Cloud-Native Developer and Dev-Ops Engineer. Freelancing for over 6 years now, I’ve been actively contributing to improve my clients position in their industries. With my expertise not only in software development, but also in the technologies and techniques at an infrastructure and architectural level, I can help to make pragmatic decisions that will deliver measurable results. Software engineering and architecting for me, started out as just a hobby, but quickly evolved into a passion, that lasts until today. I constantly seek for new adventures and challenges that will actually be of value for my customers.'}
            >
